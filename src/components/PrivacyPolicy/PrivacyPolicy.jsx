  ...
  return (
    <section className="privacy-policy">
      <div className="container">
        ...
        <div>
          <p>
            <strong>BlockBuzz</strong> ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website [www.blockbuzz.com]. Please read this policy carefully to understand our views and practices regarding your personal data.
          </p>
          ...
          <ul>
            ...
            <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to BlockBuzz, Test 1, Malmö.</li>
            ...
            <li><strong>Website</strong> refers to BlockBuzz, accessible from www.blockbuzz.com.</li>
          ...
          <ul>
            ...
            <li>By visiting this page on our website: <a href="http://www.blockbuzz.com/contact">www.blockbuzz.com/contact</a></li>
          </ul>
        </div>
      </div>
    </section>
